...
class service_container_prod_17922066 extends \Drupal\Core\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->aliases = array(
            ...
            'statistics.statistics_storage' => 'couchdb.statistics_storage',
        );
    }
    ...
    {
        $this->services['renderer'] = $instance = new \Drupal\Core\Render\Renderer($this->get('controller_resolver'), $this->get('theme.manager'), $this->get('plugin.manager.element_info'), $this->get('render_cache'), $this->get('request_stack'), array('required_cache_contexts' => array(0 => 'languages:language_interface', 1 => 'theme')));
