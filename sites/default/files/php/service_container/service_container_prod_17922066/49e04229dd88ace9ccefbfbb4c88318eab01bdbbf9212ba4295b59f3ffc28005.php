...
/**
 * service_container_prod_17922066.
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class service_container_prod_17922066 extends \Drupal\Core\DependencyInjection\Container
{
    private $parameters;
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'couchdb.statistics_storage' => 'getCouchdb_StatisticsStorageService',
            ...
            'statistics.statistics_storage' => 'getStatistics_StatisticsStorageService',
    ...
    {
        $this->services['context.repository'] = $instance = new \Drupal\Core\Plugin\Context\LazyContextRepository($this, array(0 => 'node.node_route_context', 1 => 'user.current_user_context'));
    ...
    /**
     * Gets the 'couchdb.statistics_storage' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\couchdb_statistics\StatisticsCouchdbStorage A Drupal\couchdb_statistics\StatisticsCouchdbStorage instance.
     */
    protected function getCouchdb_StatisticsStorageService()
    {
        $this->services['couchdb.statistics_storage'] = $instance = new \Drupal\couchdb_statistics\StatisticsCouchdbStorage($this->get('state'), $this->get('settings'));

        $instance->_serviceId = 'couchdb.statistics_storage';
    ...
    /**
     * Gets the 'statistics.statistics_storage' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\statistics\StatisticsDatabaseStorage A Drupal\statistics\StatisticsDatabaseStorage instance.
     */
    protected function getStatistics_StatisticsStorageService()
    {
        $this->services['statistics.statistics_storage'] = $instance = new \Drupal\statistics\StatisticsDatabaseStorage($this->get('database'), $this->get('state'), $this->get('request_stack'));

        $instance->_serviceId = 'statistics.statistics_storage';
    ...
    protected function getUrlGeneratorService()
    {
        ...
        $b = new \Drupal\Core\Routing\UrlGenerator($this->get('router.route_provider'), $this->get('path_processor_manager'), $this->get('route_processor_manager'), $this->get('config.factory'), $this->get('request_stack'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'container.modules' => array(
                ...
                'couchdb_statistics' => array(
                    'type' => 'module',
                    'pathname' => 'modules/couchdb_statistics/couchdb_statistics.info.yml',
                    'filename' => NULL,
                ),
                'datetime' => array(
                    'type' => 'module',
                ...
                'statistics' => array(
                    'type' => 'module',
                    'pathname' => 'core/modules/statistics/statistics.info.yml',
                    'filename' => 'statistics.module',
                ),
                'system' => array(
                    'type' => 'module',
            ...
            'container.namespaces' => array(
                ...
                'Drupal\\couchdb_statistics' => 'modules/couchdb_statistics/src',
                ...
                'Drupal\\statistics' => 'core/modules/statistics/src',
